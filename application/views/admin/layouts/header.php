...
<head>
    ...
    <title>Nussif Admin | <?= $title ?></title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?= site_url('admin/user/index') ?>" class="logo">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?= base_url('assets/adminlte/dist/img/user2-160x160.jpg') ?>" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?= site_url('admin/user/profile') ?>" class="btn btn-default btn-flat">Profil</a>
                                </div>
                                <div class="pull-right">
                                    <a href="#" class="btn btn-default btn-flat" id="anchorMethod" data-method="POST" data-href="<?= site_url('admin/user/logout') ?>">Keluar</a>
                                </div>
                            </li>
                        </ul>
                    </li>
